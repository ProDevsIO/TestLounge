...
class UserShare{
    ...
    public function calculateMainAgentPercent($main_agent_share_raw , $base_agent_share = null)
    {
        $base_agent_share = $base_agent_share ?? $this->setting->value;
        $main_agent_share = $main_agent_share_raw ;
        $sub_agent_share = 100 - $main_agent_share;
