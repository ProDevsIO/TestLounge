                    ...
                    <div class="col-md-12 text-center" id="banner-writeup-container">
                            <div class="row">
                                    <div class="col-md-6 "style=" padding-top:100px">
                                        ...
                                        <a href="{{ url('/product/all') }}" class="btn btn-primary btn-filled " style="font-family: Nunito;font-style: normal;font-weight: lighter;font-size: 13.625px;line-height: 19px;">Book Now</a>
                                    </div>
