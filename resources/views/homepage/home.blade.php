                        ...
                        <div class="col-md-6">
                            <div class="slider-captions">
                                ...
                                <h2 class="slider-title text-white">We provide fast Covid-19 testing for international
                                    travel.</h2>
                                <p class="slider-text hidden-xs text-white">At The Testing Lounge, our goal is to
                                    provide
                                    fast and efficient test services by collaborating with UKAS-accredited labs approved
                                    for
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="slider-captions">
                                ...
                                <p class="slider-text hidden-xs text-white">We make the testing process easy, fast and
                                    reliable with our seamless booking process. We aim to put your mind at ease as you
                                    navigate on our platform.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="margin-top:10px;">
                            <div class="service-block" style="min-height:300px;max-height:300px;">
                                ...
                                <div class="service-content">
                                    <!-- service content -->
                                    <h2 class="single"><a href="#" class="title">{{$vproduct->product->name}}</a></h2>

                                    <span class="price"
                                          style="background-color: rgb(235, 235, 235); padding: 10px 25px; border-radius: 50px;">
                                    £{{ number_format($vproduct->price_pounds,2) }}
                                </span> <br>
                    ...
                    @if($vproduct->product->classify == 1)
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="margin-top:10px;">
                            <div class="service-block" style="min-height:300px;max-height:300px;">
                                ...
                                <div class="service-content">
                                    <!-- service content -->
                                    <h2 class="bundle"><a href="#" class="title">{{$vproduct->product->name}}</a></h2>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="service-block" style="box-shadow: -3px 10px 19px -5px rgba(0,0,0,0.64);">
                        ...
                        <div class="service-content">
                            <!-- service content -->
                            <h2 class="title" style="color: #feb717;">VACCINATED (over 18s)</h2>

                            <p style="font-weight: 700;">PRIOR TO YOUR TRIP</p>
                            <ul>
                                <li>Take a <a href="/view/product/test-to-travel-fit-to-fly-from-the-uk"
                                              style="color: #feb717;">PCR Fit to Fly</a></li>
                            </ul>

                            <p style="font-weight: 700;">BEFORE YOUR RETURN TO THE UK</p>
                            <ul>
                                <li>Book a <a href="/view/product/vaccinated-day-2-mandatory-test"
                                              style="color: #feb717;">PCR Day 2 Test</a> to be taken
                                    on or before Day 2 of your arrival in the UK
                                </li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="service-block" style="box-shadow: -3px 10px 19px -5px rgba(0,0,0,0.64);">
                        ...
                        <div class="service-content">
                            <!-- service content -->
                            <h2 class="title" style="color: #feb717;">UNVACCINATED</h2>
                            ...
                            <ul>
                                <li>Take a <a href="/view/product/test-to-travel-fit-to-fly-from-the-uk"
                                              style="color: #feb717;">PCR Fit to Fly test</a>
                                    (72hrs before your trip).
                                </li>
                                <li>Book a <a href="/view/product/unvaccinated-day-2-and-day-8-mandatory-test"
                                              style="color: #feb717;">PCR Day 2 and Day 8</a> Test
                                    Package to be taken on Day 2 and Day 8 of your arrival.
                                </li>
                                <li>Complete a Passenger Locator Form in the 48 hours before your trip.</li>
                            </ul>
