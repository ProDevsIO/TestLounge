                    ...
                    <div class="col-md-12 text-center" id="banner-writeup-container">
                            <div class="row">
                                    <div class="col-md-6 "style=" padding-top:10px">
                                        ...
                                        <a href="javascript:;" id ="travel" onclick="show()" class="btn btn-primary btn-filled " style="font-family: Nunito;font-style: normal;font-weight: lighter;font-size: 13.625px;line-height: 19px;">TRAVEL CALCULATOR</a>
                                       <br>
                ...
                <div class="container-fluid" style="padding:0">
                    <div class="header text-center bg-1" style="padding:59px;">
                        ...
                        <div class="container" id="banner2">
                           ...
                           <br>
                            <p class="fw-700 fs-28"> <a href="javascript:;" type="button" class="btn btn-md bg-primary" style="border-radius:25px; padding:14px 28px 13px 28px;font-family: Nunito;font-style: normal;font-weight: bolder;font-size: 16px;line-height: 19px;color: #1E50A0 !important;background-color:white !important;">BOOK NOW</a></p>
                        </div>
                    </div>
                </div>
