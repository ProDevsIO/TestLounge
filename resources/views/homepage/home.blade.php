                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="slider-captions">
                                ...
                                <h2 class="slider-title text-white">We provide fast Covid-19 testing for international travel.</h2>
                                <p class="slider-text hidden-xs text-white">At The Testing Lounge, our goal is to provide fast and efficient test services by collaborating with UKAS-accredited labs approved for testing by the Government.</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="margin-top:10px;">
                    <div class="service-block" style="min-height:300px;max-height:300px;">
                        ...
                        <div class="service-content">
                            ...
                            <span class="price" style="background-color: rgb(235, 235, 235); padding: 10px 25px; border-radius: 50px;">
                                £{{$vproduct->price_pounds}}
                            </span> <br>

                            <a href="/view/product/{{$vproduct->product->slug}}" class="btn btn-default" style="margin-top: 50px;">Book Test</a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="service-block" style="box-shadow: -3px 10px 19px -5px rgba(0,0,0,0.64);">
                        ...
                        <div class="service-content">
                            ...
                            <ul>
                                <li>Take a <a href="test-single6.html" style="color: #cda768;">PCR Fit to Fly</a> or <a href="test-single8.html" style="color: #cda768;"> Lateral Flow Antigen Fit to Fly Test.</a></li>
                            </ul>

                            <p style="font-weight: 700;">BEFORE YOUR RETURN TO THE UK</p>
                            <ul>
                                <li>Book a <a href="test-single.html" style="color: #cda768;">PCR Day 2 Test</a> to be taken on or before Day 2 of your arrival in the UK</li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                    <div class="service-block" style="box-shadow: -3px 10px 19px -5px rgba(0,0,0,0.64);">
                        ...
                        <div class="service-content">
                            ...
                            <p style="font-weight: 700;">BEFORE YOUR RETURN TO THE UK</p>
                            <ul>
                                <li>Take a <a href="test-single6.html" style="color: #cda768;">PCR Fit to Fly test</a> (72hrs before your trip).</li>
                                <li>Book a <a href="test-single2.html" style="color: #cda768;">PCR Day 2 and Day 8</a> Test Package to be taken on Day 2 and Day 8 of your arrival.</li>
                                <li>Complete a Passenger Locator Form in the 48 hours before your trip.</li>
                            </ul>
