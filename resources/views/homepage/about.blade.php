...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="video-content">
                        ...
                        <p class="lead">
                            At The Testing Lounge, we believe you and your health should come first. We work hard to keep your mind at ease by providing <strong>clarity, a seamless booking &amp; an affordable service.</strong>
                            </p>
    ...
    <!--/.space-medium-->
    <div class="space-large bg-white text-center">
        <!--space-small-->
        <div class="container">
            <div class="row">
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
    ...
    <div class="space-medium" style="border-bottom: 2px solid white;">
        <!--space-medium-->
        <div class="container">
            <div class="row">
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
