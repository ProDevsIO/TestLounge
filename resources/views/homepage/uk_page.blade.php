...
<div class="main-container" style="margin-bottom: 50px">
    ...
    <header class="page-header" style="height: 450px;padding-top: 50px">
        <div class="background-image-holder parallax-background">
            <img class="background-image" alt="Background Image" src="/img/bigben2.jpg" >
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 "style=" padding-top:10px">
                            ...
                            <p style="color: #fff;text-align: left">
                                The Mandatory Covid-19 Tests for entry into the UK, depends on your vaccination status and what Country you are travelling from.
        ...
        <div class="container">
            <div class="table-responsive">
                ...
                <table className="font-16">
                    ...
                    <tr>
                        <td class="bg-sky" width="35.5%"><h6>Mandatory PCR test on Day 8 of arrival into the UK. </h6></td>
                        <td class="bg-sky" width="10%">
                        <img src="https://img.icons8.com/material-sharp/24/000000/delete-sign.png"/>
                        </td>
                        <td class="bg-sky" width="10%">
