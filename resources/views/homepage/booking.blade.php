                                ...
                                <div class="col-md-12">
                                    <div style="margin-top: 10px">
                                        ...
                                        <div class="radio-group">
                                            ...
                                            <div class='radio'
                                                 style="background:none;border:none;padding: 20px 20px 20px 100px;height: 150px;border-radius:25px"
                                                 data-value="vastech" onclick ="run()">
                                                <img src="https://dashboard.smartpay.ng/images/logo.png"
                                                     style="padding-bottom: 0px;margin-left: -38px;width:150px"/> <span><label>
