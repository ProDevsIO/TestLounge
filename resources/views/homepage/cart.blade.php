                ...
                <br>
                    ...
                    <br>
                        <div class="card fw-600 bg-7">
                            ...
                            <div class="card-item color-6">
                               <a class="btn btn-sm btn-danger" style ="background-color:#f1315d;margin-bottom:2px;" href="javascript:;" onclick="remove(' {{$cart->id}}')"> <i class="icon icon_trash"> </i> Remove </a>
                               <br>
                               <a class="btn btn-sm btn-info" style ="background-color:#1a8bb3;margin-bottom:2px;"  href="javascript:;" onclick="update(' {{$cart->id}}', '{{$i}}')"> <i class="icon icon_pencil"> </i> Update </a>
                            </div>
                        </div>
                        <?php $i++; ?>
                    @endforeach
                    <div class="container text-center fw-700 ">
                        TOTAL: <span class="color-1 price">£ {{$cartSum}}</span>
                    </div>
